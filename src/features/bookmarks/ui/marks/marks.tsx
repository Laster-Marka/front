    ...
    <main>
      <div className={cx('main-div')}>
        ...
        <CreateMark
          ...
          isModalOpened={isMarkModalOpen}
          onMarkCreated={onMarkCreated}
          onModalReset={() => setIsMarkModalOpen(false)}
          onUserAction={onUserAction}
        />
        <Modal
          isOpened={isDeleteFolderModalOpen}
          onExitModal={() => {
            setIsDeleteFolderModalOpen(false)
            setDeleteFolderID('')
          }}
        >
          ...
          <div className={cx('folder-delete-modal')}>
            The folder will be deleted, including all bookmarks in the folder!
          </div>
          <Button theme={'primary'} onClick={() => deleteFolder(deleteFolderID)}>
            Delete
          </Button>
        </Modal>
      </div>
