...
describe('signup', () => {
  it('should sign up a new user', async () => {
    ...
    when(storage.getItem('users')).thenReturn(
      `[{"id":"2","email":"albert@laster.com","password":"albert","name":"albert"}]`,
    )
    const user: UserRegister = {
      name: 'Patxi',
      email: 'patxi@laster.com',
      password: 'patxipatxi',
      confirmPassword: 'patxipatxi',
    }
...
describe('signup email exist', () => {
  it('should return duplicated email', async () => {
    const { storage, userLocalRepository } = setup()
    when(storage.getItem('users')).thenReturn(
      `[{"id":"2","email":"albert@laster.com","password":"albert","name":"albert"},{"id":"1","email":"patxi@laster.com","name":"Patxi","password":"patxipatxi","createdAt":"2019-01-17T00:00:00.000Z","updatedAt":"2019-01-30T00:00:00.000Z"}]`,
    )
    const user: UserRegister = {
      name: 'Patxi',
      email: 'patxi@laster.com',
...
describe('signup name exist', () => {
  it('should return duplicated name', async () => {
    const { storage, userLocalRepository } = setup()
    when(storage.getItem('users')).thenReturn(
      `[{"id":"2","email":"albert@laster.com","password":"albert","name":"albert"},{"id":"1","email":"patxi1@laster.com","name":"Patxi","password":"patxipatxi","createdAt":"2019-01-17T00:00:00.000Z","updatedAt":"2019-01-30T00:00:00.000Z"}]`,
    )
    const user: UserRegister = {
      name: 'Patxi',
      email: 'patxi@laster.com',
