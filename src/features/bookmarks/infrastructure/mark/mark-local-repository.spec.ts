...
describe('findAll', () => {
  it('should find all folders', async () => {
    ...
    when(storage.getItem('folders')).thenReturn(
...
describe('edit', () => {
  it('should edit a mark', async () => {
    ...
    const editMark: Mark = {
      ...
      image: '',
      markdown: '',
      createdAt: new Date('2019-01-16T00:00:00.000Z'),
      updatedAt: new Date('2019-01-20T00:00:00.000Z'),
    }
...
describe('delete folder', () => {
  it('should delete a folder', async () => {
    ...
    const folder: Folder = {
      ...
      createdAt: new Date('2019-01-17T00:00:00.000Z'),
      updatedAt: new Date('2019-01-30T00:00:00.000Z'),
    }
...
function setup() {
  ...
  return {
    storage,
    markLocalRepository: new MarkLocalRepository(
      instance(storage),
