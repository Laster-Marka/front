...
export class MarkRepositoryFactory {
  static build(): MarkRepository {
    return new MarkHttpRepository(new MarkDtoToMarkMapper(new TagDtoToTagMapper()), new MarkToEditMarkDtoMapper(new TagToTagDtoMapper()), new FolderToEditFolderDtoMapper())
  }
